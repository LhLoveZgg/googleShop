      ...
      <div class="swiper-container banner1">
        <div class="swiper-wrapper">
          <div class="swiper-slide slide1">
            <img
              src="
            //5ororwxhmplorik.ldycdn.com/cloud/iqBqjKmrRinSilliinln/lunbo.jpg"
              alt
              srcset
            />
            <div class="text">
    ...
    <div class="introduce">
      <div class="container">
        <div class="title">
          ...
          <div class="imgList">
            <img src="//5prorwxhmplojik.ldycdn.com/cloud/imBqjKmrRinSrlpjjjln/gongsi.jpg" alt />
            <img src="//5qrorwxhmploiik.ldycdn.com/cloud/iqBqjKmrRinSrlpjrjln/chejian.jpg" alt />
          </div>
        </div>
      </div>
    </div>
