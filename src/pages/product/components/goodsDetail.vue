@<template>
  <div class="goodsDetail">
    ...
    <div>
      ...
      <div class="deal">
        <h4>Double Cone Powder Mixer blender</h4>
        <p>
          SZH series double cone powder mixer blender is most often used for
          intimate mixing of dry powder or small granules with good flowability.
        </p>
        <div class="count">
          <span>Quantity:</span>
          <div>
